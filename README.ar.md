...
Block يسقط الترافيك بدل توجيهه: نطاقات الإعلانات والتتبع، ونقاط إرسال القياسات، وموقع لا تريد فتحه في هذا المتصفح. القواعد المرفقة ترسل عائلات `geosite:ads` إلى Block أصلًا، لذا بقاء Block فارغًا هو الحالة الطبيعية. وإذا حُجبت صفحة على غير المتوقع، تذكر صفحة الحجب اسم الملف والقاعدة وتتيح حذفها من هناك.
